                    ...
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form method="POST" enctype="multipart/form-data"  action="{{ route('posts.update', $posts->id) }}">
                                @csrf
                                @method('PUT')
                                <input type="hidden" id="editUserId" data-id="{{$posts->id}}">
                                <div class="row mb-4 ">
                                    <div class="col">
                                        <div  class="form-outline">
                                            <label class="form-label fw-bold " for="title">Title</label>
                                            <input type="text" id="title" class="form-control"  value="{{$posts->title}}" name="title" placeholder="Enter First name"/>
                                ...
                                <div class="row mb-4">
                                    <div class="col">
                                        <div  class="form-outline">
                                            ...
                                            <input type="text" id="description" class="form-control"  value="{{$posts->description}}" name="description" placeholder="Enter Last name"/>
                                ...
                                <div class="row mb-4">
                                    <div class="col">
                                        <div  class="form-outline">
                                            ...
                                            <input type="text" id="status" class="form-control"  value="{{$posts->status}}" name="status" placeholder="Enter Last name"/>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="file" class="form-control" id="customFilepost" name="imagePost"/>
                                    @if ($posts->image)
                                        <img src="{{$posts->postimageUrl}}" alt="User Image" class="img-thumbnail mt-2" style="max-width: 150px;">
                                    @else
