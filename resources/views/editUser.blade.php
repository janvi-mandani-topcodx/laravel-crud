            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('users.update', $users->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row mb-4">
                                <div class="col">
                            ...
                            <div class="form-outline mb-4">
                                <label class="form-label fw-bold" for="customFile">Select image</label>
                                <input type="file" class="form-control" id="customFile" name="image"/>
                                @if ($users->image)
                                    <img src="{{ asset('storage/' . $users->image) }}" alt="User Image" class="img-thumbnail mt-2" style="max-width: 150px;">
                                @else
